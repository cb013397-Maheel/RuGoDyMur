        ...
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                @if(auth()->user()->type == 'admin')
                    ...
                    <x-nav-link href="{{ route('admin.orders.index') }}" :active="request()->routeIs('order.index')">
                        {{ __('Orders') }}
                    </x-nav-link>
                ...
                @if(auth()->user()->type == 'user')
                    ...
                    <x-nav-link href="{{ route('customer.orders.index') }}" :active="request()->routeIs('order.index')">
                        {{ __('Orders') }}
                    </x-nav-link>
                @endif
